						...
						<Grid item xs={12} md={10}>
							...
							<Grid container spacing={1} mb={2}>
								...
								<Grid item xs={9} container direction="column" alignItems="flex-end">
									<Button variant="contained" color="secondary" startIcon={<ApprovalIcon/>}>자료복사</Button>
								</Grid>
							</Grid>
						</Grid>
					</Grid>
					...
					>
						<Grid item xs={12} md={10}>
							...
							<Grid container spacing={1} mb={2}>
								...
								<Grid item xs={9} container direction="column" alignItems="flex-end">
									<Button variant="contained" color="secondary" startIcon={<ApprovalIcon/>}>예산편성</Button>
								</Grid>
							</Grid>
						</Grid>
					</Grid>
